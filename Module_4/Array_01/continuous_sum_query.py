...
Each devotee gives a fixed amount of coin(according to their faith and ability) to
some K beggars sitting next to each other.
...
Second devotee donated 20 coins to beggars ranging from 2 to 3. Final amount in each
beggars pot after second devotee: [10, 30, 20, 0, 0]
...
if __name__ == '__main__':
    ...
    print(continuous_sum_query(A, B))
