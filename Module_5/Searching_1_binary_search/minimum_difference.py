...
row 1 will become X[1], element picked from row 2 will become X[2], and so on.
...
Explanation 2:
Newly build array : [3, 2, 4]. The minimum cost will be 1 since the
minimum absolute difference will be 1(3 - 2).
"""
